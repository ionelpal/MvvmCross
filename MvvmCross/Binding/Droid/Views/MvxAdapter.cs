...
namespace MvvmCross.Binding.Droid.Views
{
        ...
        , IMvxAdapter
    {
        ...
        private int _simpleViewLayoutId = 
            Resource.Layout.MvxSimpleListItem1;
        private int _simpleDropDownViewLayoutId = 
            Resource.Layout.MvxSimpleSpinnerDropDownItem;
		...
		public virtual int SimpleViewLayoutId
		{
			get => _simpleViewLayoutId;
			set => SetItemTemplate(ref _simpleViewLayoutId, value);
		}

		public virtual int SimpleDropDownViewLayoutId
		{
			get => _simpleDropDownViewLayoutId;
			set => SetItemTemplate(ref _simpleDropDownViewLayoutId, value);
		}
        ...
        public override View GetDropDownView(int position, View convertView, ViewGroup parent) 
            => GetView(position, convertView, parent, 
               DropDownItemTemplateId == 0 ? SimpleDropDownViewLayoutId : DropDownItemTemplateId);

        public override View GetView(int position, View convertView, ViewGroup parent) 
            => GetView(position, convertView, parent, 
               ItemTemplateId == 0 ? SimpleViewLayoutId : ItemTemplateId);
        ...
        protected virtual IMvxListItemView CreateBindableView(
            ...
            new MvxListItemView(Context, BindingContext.LayoutInflaterHolder, 
